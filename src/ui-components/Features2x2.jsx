        ...
        >
          ...
          >
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Real Time monitoring of all connected devices from one centralized location."
              {...getOverrideProps(
                overrides,
                "Real Time monitoring of all connected devices from one centralized location."
              )}
            ></Text>
          </Flex>
        </Flex>
        ...
        >
          ...
          >
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Global Risk Registers"
              {...getOverrideProps(overrides, "Global Risk Registers")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            ...
            <Text
              ...
              {...getOverrideProps(overrides, "Training Modules")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
